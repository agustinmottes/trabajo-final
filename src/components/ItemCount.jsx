...
const ItemCount = ({stock,onAdd}) => {
    ...
    return (
        <div>
            ...
            <div className="row md-3 my-5 py-5">
                <div className="col-md3  text-center ">
                  {vendido ?  <Link to={ "/cart"} className="btn btn-outline-primary" >Terminar Mi Compra</Link> :<button 
                  type="button" className="btn btn-outline-primary" onClick={()=>{addToCart(counter)}}>Agregar
                   a Carrito</button>} 
                </div>
